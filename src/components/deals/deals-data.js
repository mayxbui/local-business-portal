import img1 from '../../assets/deals/1.png'
import img2 from '../../assets/deals/2.png'
import img3 from '../../assets/deals/3.png'
import img4 from '../../assets/deals/4.png'
import img5 from '../../assets/deals/5.png'
import img6 from '../../assets/deals/6.png'
import img7 from '../../assets/deals/7.png'
import img8 from '../../assets/deals/8.png'
...
const dealsData = [
    {
      ...
      description:
        "Enjoy a delightful meal at Almost Home and then head over to Marvin’s for a sweet treat—10% off at both locations when you shop with us! Whether you’re savoring a delicious dinner or indulging in something sweet, the night is yours to make extra special.",
      discounts: [
        "Get 10% off at Marvin’s",
        "Get 10% off at Almost Home",
      ],
    ...
    },
    {
      ...
      description:
        "Buy stunning flowers at Silver Bell Flowers, then add a pop of style with a chic find at Blushing Beaus Boutique—$7 off at one and 5% off at the other! Perfect for a burst of color in your wardrobe and your home.",
      discounts: [
        "Get $7 off at Blushing Beaus Boutique",
        "Get 5% off at Silver Bell Flowers",
      ],
    ...
    },
    {
      ...
      description:
        "Start with delicious tacos at Taco Wapo, then enjoy a hearty meal at Marvin’s—$5 off at one and 10% off at the other! A perfect combo for those who love great food and even greater deals. Grab your food and enjoy the savings!",
      discounts: [
        "Get $5 off at Marvin’s",
        "Get 10% off at Taco Wapo",
      ],
    ...
    },
    {
      ...
      description:
        "Enjoy a hearty brunch at Fluttering Duck with 15% off, then step out in style with 10% off at Burdge Boots & Boutique. Not only will you fill your belly, but you’ll also get an amazing deal on your next pair of boots. A cozy combo to kickstart your day!",
      discounts: [
        "Get 10% off at Burdge Boots & Boutique",
        "Get 15% off at The Fluttering Duck",
      ],
